...
.onAttach <- function(...) {
  ...
  assign( x = ".currentRepo", value = "http://beta.icm.edu.pl:8080/archivist2_upload.php", envir = .ArchivistEnv )
  assign( x = ".confirmation", value = "File uploaded. Database updated. ", envir = .ArchivistEnv )
}
